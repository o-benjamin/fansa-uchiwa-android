...
enum class StickerAsset(
    ...
    HEART_CUTE("heart_cute", R.drawable.sticker_heart_cute, isNew = true),
    HEART_HORIZONTAL("heart_horizontal", R.drawable.sticker_heart_horizontal, isNew = true),
    HEART_VERTICAL("heart_vertical", R.drawable.sticker_heart_vertical, isNew = true),
