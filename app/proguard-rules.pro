...
# AGP が生成した build/outputs/mapping/<ビルドタイプ>/missing_rules.txt の提案どおり（review-ktx 2.0.2 時点、
# gradle/libs.versions.toml の playReview）。上げたらこの行を外し、:app:assembleBeta が通るか試す。
# ---------------------------------------------------------------------------
